...
from homebase_cli.registry import add_node, add_role_group, assign_node_role_group, load_nodes, load_role_groups, set_node_state
...
def test_render_ansible_inventory_uses_registered_nodes(tmp_path: Path) -> None:
    ...
    set_node_state("control", "status", "active", path=path)
